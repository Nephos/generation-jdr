...
function detailport($i)
{
    ...
    if ($i==1) {
        $sortie=$detailportefaible[rand(0, count($detailportefaible)-1)];
    } elseif ($i==2) {
        $sortie=$detailportemoyen[rand(0, count($detailportemoyen)-1)];
    } else {
        $sortie=$detailportehaut[rand(0, count($detailportehaut)-1)];
    }
