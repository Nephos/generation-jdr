...
if (!empty($_POST)) {
    ...
    if (count($objart)!=0) {
        if (count($objart)>1) {
            $output.= '<h2>'.count($objart).' objets arts</h2>';
        } else {
            $output.= '<h2>'.count($objart).' objet art</h2>';
        }
    ...
    if (count($objnm)!=0) {
        if (count($objnm)>1) {
            $output.= '<h2>'.count($objnm).' objets non magiques</h2>';
        } else {
    ...
    if (count($objmaj)!=0) {
        if (count($objmaj)>1) {
            $output.= '<h2>'.count($objmaj).' objets magiques</h2>';
        } else {
            $output.= '<h2>'.count($objmaj).' objet magique</h2>';
        }
